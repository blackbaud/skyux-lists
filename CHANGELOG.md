...
- Fixed the repeater item component to properly hide the expand/collapse chevron when there is no item content. [#84](https://github.com/blackbaud/skyux-lists/pull/84) (Thanks [@blackbaud-GavinNicol](https://github.com/blackbaud-GavinNicol)!)

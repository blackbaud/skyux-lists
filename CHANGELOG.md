...
- Fixed the repeater component to not reset items which have been reordered when reorderability is toggled off. [#255](https://github.com/blackbaud/skyux-lists/pull/255)

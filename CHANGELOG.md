...
- Added the `itemName` property to the repeater item to provide better accessibility labels. Fixed the repeater item controls to have descriptive aria labels and fixed the repeater item to no longer be focus-able. [#262](https://github.com/blackbaud/skyux-lists/pull/262)

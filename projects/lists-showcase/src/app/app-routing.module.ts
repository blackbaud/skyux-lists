...
import { RepeaterSingleSelectVisualComponent } from './visual/repeater/repeater-single-select-visual.component';
...
const routes: Routes = [
  ...
  {
    path: 'visual/single-select-repeater',
    component: RepeaterSingleSelectVisualComponent,
  },
  {
    path: 'visual/sort',
